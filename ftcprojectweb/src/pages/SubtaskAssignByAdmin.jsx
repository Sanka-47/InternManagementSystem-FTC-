...
import { createSubtask, listInternsForProjectByAdmin } from "../services/admin";
...
export default function SubtaskAssignByAdmin() {
  ...
  useEffect(() => {
    async function fetchInterns() {
      try {
        const res = await listInternsForProjectByAdmin(projectId); // pass projectId
        setInterns(res);
      } catch (e) {
        console.error(e);
