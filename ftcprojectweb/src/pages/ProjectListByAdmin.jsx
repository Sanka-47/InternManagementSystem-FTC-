...
import { listProjects } from "../services/admin";
      ...
      <main className="flex-1 p-6 space-y-6">
        ...
        {projects.length === 0 && !loading && !err && (
          <div className="text-center text-gray-500 p-4">
            You have not created any projects yet. Click the button above to create a new project.
          </div>
        )}
        {projects.length > 0 && (
                  ...
                  <tr key={p.id} className="border-t text-center">
                    ...
                    <td className="py-2 pr-4 space-x-2">
                      <Button
                        ...
                        onClick={() => nav(`/admin/projects/${p.id}/kanban`)}
                      >
                        View Kanban Board
                      </Button>
                      <Button
                        className="w-auto px-3 py-1 bg-green-600 hover:bg-green-700"
                        onClick={() => nav(`/admin/projects/${p.id}/tasks/new`)}
                      >
                        + Task
                      </Button>
                    </td>
