...
import { createProject, listCohortsForAdmin } from "../services/admin";
...
export default function ProjectCreate() {
  ...
  useEffect(() => {
    listCohortsForAdmin().then(setCohorts).catch(() => setCohorts([]));
  }, []);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mt-6 p-6">
        <Form title="Create Project" subtitle="Assign project to a cohort" onSubmit={onSubmit}>
          ...
          {err && <div className="font-semibold text-red-600 text-sm">{err}</div>}
